package com.neimeng.workflow.parallelGateWay;
...
public class HelloWorld01 extends WorkflowApplicationTests {
    ...
    public void deploymentProcessDefinition() {
        Deployment deployment = repositoryService
                ...
                .name("并行网关")//添加部署的名称
                .addClasspathResource("processes/ParallelGateWay.bpmn")//从classpath的资源中加载，一次只能加载一个文件
                .deploy();//完成部署
    ...
    public void startProcessInstance() {
        //根据流程定义的key启动流程
        String processDefinitionKey = "ParallelGateWay001";
    ...
    public void completeMyPersonalTask() {
        completeTask("345005", "345007", "345009");
        queryCurrentTask();
    }
