 ...
 * 测试通过一个流程变量设置所有子流程结束
 */
public class MuitiInstanceAndSubProcessTest010 extends WorkflowApplicationTests {
    ...
    public void deploymentProcessDefinition() {
        Deployment deployment = repositoryService
                ...
                .addClasspathResource("processes/muitiProcess010.bpmn20.xml")// 从classpath的资源中加载，一次只能加载一个文件
                .deploy(); // 部署
    ...
    public void startProcessInstance() {
        // 根据流程定义的key启动流程
        String processDefinitionKey = "muitiSubProcess0010";
