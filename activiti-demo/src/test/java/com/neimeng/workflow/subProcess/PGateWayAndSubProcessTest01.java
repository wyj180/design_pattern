 ...
 * 测试通过 子流程中使用并行网关
 */
public class PGateWayAndSubProcessTest01 extends WorkflowApplicationTests {
    ...
    public void deploymentProcessDefinition() {
        Deployment deployment = repositoryService
                ...
                .name("子流程中使用并行网关")// 添加部署的名称
                .addClasspathResource("processes/PGateWayAndSubProcess2.bpmn")// 从classpath的资源中加载，一次只能加载一个文件
                .deploy(); // 部署
    ...
    public void startProcessInstance() {
        // 根据流程定义的key启动流程
        String processDefinitionKey = "PGateWayAndSubProcess02";
...
//        variables.put("userNameList", Arrays.asList("MM", "NN"));
    ...
    public void completeTask() {
        String taskId = "350015";
        Map<String, Object> variables = new HashMap<>();
//        variables.put("endSubProcessLife", true); //
