 ...
 *
 */
public class ProcessInstanceDemo extends FlowableDemoApplicationTests {
    ...
    /**
     * 第二步：启动流程实例，根据流程部署ID 启动
     */
    @Test
    public void startProcessInstanceByDeploymentID() {
        //根据流程定义的key启动流程
        String processDefinitionKey = "myServiceTaskProcess";
